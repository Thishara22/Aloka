...
class ClassTimetableController extends Controller
{
    public function list(Request $request)
    {
        ...
        foreach($getWeek as $value)
        {
            ...
            {
                $ClassSubject = ClassSubjectTimetableModel::getReordClassSubject($request->class_id,$request->subject_id,$value->id);
    ...
    public function MyTimetable()
    {
        ...
        foreach($getRecord as $value)
        {
            ...
            foreach($getWeek as $valueW)
            {
                ...
                $ClassSubject = ClassSubjectTimetableModel::getReordClassSubject($value->class_id,$value->subject_id,$valueW->id);
    ...
    public function MyTimetableTeacher($class_id,$subject_id)
    {
        ...
        $data['getSubject'] = SubjectModel::getSingle($subject_id);
            ...
            foreach($getWeek as $valueW)
            {
                ...
                $ClassSubject = ClassSubjectTimetableModel::getReordClassSubject($class_id,$subject_id,$valueW->id);
