...
Route::group(['middleware' => 'admin'],function (){
    ...
    Route::get('admin/notice_board', [CommunicateController::class, 'NoticeBoard']);
    Route::get('admin/notice_board/add', [CommunicateController::class, 'AddNoticeBoard']);
    Route::post('admin/notice_board/add', [CommunicateController::class, 'InsertNoticeBoard']);

    Route::get('admin/notice_board/edit/{id}', [CommunicateController::class, 'EditNoticeBoard']);
    Route::post('admin/notice_board/edit/{id}', [CommunicateController::class, 'UpdateNoticeBoard']);
    Route::get('admin/notice_board/delete/{id}', [CommunicateController::class, 'DeleteNoticeBoard']);
