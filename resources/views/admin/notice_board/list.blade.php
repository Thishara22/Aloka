      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right">
            <a href="{{ url('admin/notice_board/add') }}" class="btn btn-primary">Add New Notice Board</a>
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="card-header">
              ...
              <div class="row">
                <div class="form-group col-md-2">
                  ...
                  <a href="{{ url('admin/notice_board') }}" class="btn btn-success" style="margin-top: 10px;">Reset</a>
                  </div>
              </div>
                </div>
              </form>
                  ...
                  <tbody>
                    @forelse($getRecord as $value)
                      <tr>
                        ...
                        <td>
                          <a href="{{ url('admin/notice_board/edit/'.$value->id) }}" class="btn btn-primary">Edit</a>
                          <a href="{{ url('admin/notice_board/delete/'.$value->id) }}" class="btn btn-danger">Delete</a>
                        </td>
                      </tr>
                    @empty
                      <tr>
