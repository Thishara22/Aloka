...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="javascript:;" class="brand-link" style="text-align: center;">
      <span class="brand-text font-weight-light" style="font-weight: bold !important;font-size: 20px;">Aloka College</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('admin/notice_board') }}" class="nav-link @if(Request::segment(2) == 'notice_board') active @endif">
              <i class="nav-icon far fa-user"></i>
              <p>
                Notice Board
              </p>
